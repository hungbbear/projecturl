...
%>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div>
                                    <div class="ibox-content no-padding border-left-right">
                                        <img alt="image" class="img-responsive" src="<c:url value="/resources/img/profile_big.jpg"/>">
                                    </div>
                                ...
                                <div class="ibox-content">
                                    <div class="card">
                                        <div class="card-block">
                                            <form class="form-horizontal form-material" action="edit" method="POST">
                                                <div class="form-group">
                                                    <label class="col-md-12">Full Name</label>
                                                    <div class="col-md-12">
                                                        <input type="text" value="<%=session.getAttribute("name")%>" class="form-control form-control-line" name="username" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="password" placeholder="Xác nhận mật khẩu" class="form-control form-control-line" name="password2"> 
                                                    </div>
                                                </div>
    ...
    <!-- Mirrored from webapplayers.com/inspinia_admin-v2.7.1/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 15:24:20 GMT -->
</html>
